...
open NewsParser.NewsCrawler
open NewsParser.Visualizer
...
let () = 
  ...
  gen_trees 8 ids;
  print_string "Done generating! Files are under /dot_files. Call dot -Tpng dot_files/[file] > tree_images/[desired name].png to see the image! \n"
;;
