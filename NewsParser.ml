...
let () = 
  ...
  let json1_rec = (parse json1) in
  print_string "It looks like the article ";
  print_string (unwrap json1_rec.title);
  print_string " is about ";
  print_list (generate_keywords (unwrap json1_rec.text) 5); 
  print_string "\n";
  let json2_rec = (parse json2) in
  print_string "It looks like the article ";
  print_string (unwrap json2_rec.title);
  print_string " is about ";
  print_list (generate_keywords (unwrap json2_rec.text) 3)
  (* print_string "\n"; *)
  (* Un-Comment to Test JSON Parsing: *)
  (* print_string "JSON 1 Data:\n";
  (print_json (parse json1));
  print_string "\n JSON 2 Data:\n";
  (print_json (parse json2)); *)  
  (* Un-Comment to Test Tokenizer:*)
